...
<head>
	...
	<!-- Google jQuery CDN for pre-filled edit modal or any modal-->
							...
							<div class="row d-flex justify-content-center align-items-center h-100 ">
								<div class="col-lg-12 col-xl-12">
									<div class="card rounded-3">
										<img src="https://registrationmagic.com/wp-content/uploads/2019/03/hero_banner.jpg" class="w-100" style="border-top-left-radius: .3rem; border-top-right-radius: .3rem;" alt="Sample photo">
...
**************************************-->
<script>
	var emp_array = getEmployeeData(); /*This function code is below */
