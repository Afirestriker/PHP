...
<body class="bg-light">
	...
	<nav class="container my-5">
		...
		<div class="tab-content border border-top-0 py-4 px-3">
			<!-- Tsb: Home Content -->
			<div id="nav-home" class="tab-pane fade show active "> <h5>Home Tab Content</h5> </div>
...
<script>
	var chart = AmCharts.makeChart( "dayMonth_chartdiv", {
	  ...
	  "dataProvider": [ {			/*This is array that provides data for chart*/
		    "month": "Jul 01, 2022",
		    "energy": 25,
		    "ins": 21,
		    "color": "#74dba8"
	  ...
	  "categoryField": "month",		/*This is X-axis category or Label*/
...
<script>
	var chart = AmCharts.makeChart( "dayWeek_chartdiv", {
	  ...
	  "categoryField": "week",		/*This is X-axis category or Label*/
...
<script>
	var chart = AmCharts.makeChart( "yearly_chartdiv", {
	  ...
	  "categoryField": "year",		/*This is X-axis category or Label*/
